...
#            organizationId: 'cd5328432d2b4c1d987df64366cff616'
#            appId: '2205cdf757'
#            secretToken: '367cf2a1cf9b3d1461c0a63f53c562a14e9cdb51'

# opbeat.captureError(new Error('is opbeat ok?'))
...
get_maxlevels_all = (callback) ->
  wf.wow.get_all_by_filter {type:"member","armory.level":110,"whats_changed.changes.level":{$exists:true}},null,(wowthings) ->
    get_feed wowthings, callback
...
wf.app.get '/debug/item/:item_id', (req, res) ->
